package Exam.SecondMidtermExam.Task23.Tester;
import Exam.SecondMidtermExam.Task23.AuditionTest;
...
public class Tester {
    ...
    private AuditionTest tester;
    private static String FILE_PATH;
    private static Scraper SCRAPER;

    @BeforeAll
    static void test() throws IOException, InterruptedException {
        FILE_PATH = "src/Exam/SecondMidtermExam/Task23/Tester/";
        //https://github.com/stefanandonov/NP_code_export/tree/master/Audition
        SCRAPER = new ScrapeGithub("https://raw.githubusercontent.com/stefanandonov/NP_code_export/master/Audition/test_cases");
