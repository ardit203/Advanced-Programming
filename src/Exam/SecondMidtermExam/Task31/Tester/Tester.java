package Exam.SecondMidtermExam.Task31.Tester;
import Exam.SecondMidtermExam.Task31.StaduimTest;
...
public class Tester {
    ...
    private StaduimTest tester;
    private static String FILE_PATH;
    private static Scraper SCRAPER;

    @BeforeAll
    static void test() throws IOException, InterruptedException {
        FILE_PATH = "src/Exam/SecondMidtermExam/Task31/Tester/";
        //https://github.com/stefanandonov/NP_code_export/tree/master/Stadium
        SCRAPER = new ScrapeGithub("https://raw.githubusercontent.com/stefanandonov/NP_code_export/master/Stadium/test_cases");
