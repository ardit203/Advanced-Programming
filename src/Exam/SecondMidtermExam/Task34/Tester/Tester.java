package Exam.SecondMidtermExam.Task34.Tester;
import Exam.SecondMidtermExam.Task34.TextProcessorTest;
...
public class Tester {
    ...
    private TextProcessorTest tester;
    private static String FILE_PATH;
    private static Scraper SCRAPER;

    @BeforeAll
    static void test() throws IOException, InterruptedException {
        FILE_PATH = "src/Exam/SecondMidtermExam/Task34/Tester/";
        //https://github.com/stefanandonov/NP_code_export/tree/master/Text%20processor%202%20(50)
        SCRAPER = new ScrapeGithub("https://raw.githubusercontent.com/stefanandonov/NP_code_export/master/Text%20processor%202%20(50)/test_cases");
