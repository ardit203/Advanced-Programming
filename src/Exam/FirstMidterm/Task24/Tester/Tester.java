package Exam.FirstMidterm.Task24.Tester;
import Exam.FirstMidterm.Task24.BooksTest;
...
public class Tester {
    ...
    private BooksTest tester;
    private static String FILE_PATH;
    private static Scraper SCRAPER;

    @BeforeAll
    static void test() throws IOException, InterruptedException {
        FILE_PATH = "src/Exam/FirstMidterm/Task24/Tester/";
        //https://github.com/stefanandonov/NP_code_export/tree/master/Books%20collection
        SCRAPER = new ScrapeGithub("https://raw.githubusercontent.com/stefanandonov/NP_code_export/master/Books%20collection/test_cases");
