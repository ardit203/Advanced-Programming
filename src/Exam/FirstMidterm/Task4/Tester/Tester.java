...
// you will get some errors in the timestamps, but anything else will be ok
public class Tester {
    ...
    static void test() throws IOException, InterruptedException {
        FILE_PATH = "src/Exam/FirstMidterm/Task4/Tester/";
        //https://github.com/stefanandonov/NP_code_export/tree/master/Log%20Processor
        SCRAPER = new ScrapeGithub("https://raw.githubusercontent.com/stefanandonov/NP_code_export/master/Log%20Processor/test_cases");
