...
public class Tester {
    ...
    static void test() throws IOException, InterruptedException {
        FILE_PATH = "src/Exam/FirstMidterm/Task5/Tester/";
        //https://github.com/stefanandonov/NP_code_export/tree/master/MinMax
        SCRAPER = new ScrapeGithub("https://raw.githubusercontent.com/stefanandonov/NP_code_export/master/MinMax/test_cases");
