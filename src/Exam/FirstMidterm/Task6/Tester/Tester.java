...
public class Tester {
    ...
    static void test() throws IOException, InterruptedException {
        FILE_PATH = "src/Exam/FirstMidterm/Task6/Tester/";
        //https://github.com/stefanandonov/NP_code_export/tree/master/Stacked%20canvas
        SCRAPER = new ScrapeGithub("https://raw.githubusercontent.com/stefanandonov/NP_code_export/master/Stacked%20canvas/test_cases");
