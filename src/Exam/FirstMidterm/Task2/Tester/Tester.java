...
public class Tester {
    ...
    static void test() throws IOException, InterruptedException {
        FILE_PATH = "src/Exam/FirstMidterm/Task2/Tester/";
        //https://github.com/stefanandonov/NP_code_export/tree/master/Canvas%202
        SCRAPER = new ScrapeGithub("https://raw.githubusercontent.com/stefanandonov/NP_code_export/master/Canvas%202/test_cases");
