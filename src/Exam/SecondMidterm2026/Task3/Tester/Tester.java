package Exam.SecondMidterm2026.Task3.Tester;
import Exam.SecondMidterm2026.Task3.NewsSystemTest;
...
public class Tester {
    ...
    private NewsSystemTest tester;
    private static String FILE_PATH;
    private static Scraper SCRAPER;

    @BeforeAll
    static void test() throws IOException, InterruptedException {
        FILE_PATH = "src/Exam/SecondMidterm2026/Task3/Tester/";
        SCRAPER = new ScrapeCourses("https://courses.finki.ukim.mk/mod/quiz/attempt.php?attempt=786760&cmid=168531&page=2&mdlscrollto=2496.666748046875");
