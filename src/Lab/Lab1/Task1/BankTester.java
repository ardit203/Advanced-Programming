...
public class BankTester {
    ...
    public static void main(String[] args) {
        ...
        switch (test_type) {
            ...
            case "equals":
                testEquals();
                break;
            case "forEachConditional"://Additional Requirement
    ...
    private static void testForEachConditional() {
        Account a1 = new Account("Person 1", 13000.0);
        Account a2 = new Account("Person 2", 500.0);
        Account a3 = new Account("Person 3", 243000.0);
        Account a4 = new Account("Person 4", 20.0);
        Account[] accounts = {a1, a2, a3, a4};
        Bank bank = new Bank("HalkBank", accounts);
        System.out.println(bank);
        Predicate<Account> predicate = a -> a.getBalance() > 10000.0;
