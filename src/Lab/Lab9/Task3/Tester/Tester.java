package Lab.Lab9.Task3.Tester;
import Lab.Lab9.Task3.MailingListTest;
...
public class Tester {
    ...
    private MailingListTest tester;
    private static String FILE_PATH;
    private static Scraper SCRAPER;

    @BeforeAll
    static void test() throws IOException, InterruptedException {
        FILE_PATH = "src/Lab/Lab9/Task3/Tester/";
        SCRAPER = new ScrapeCourses("https://courses.finki.ukim.mk/mod/quiz/attempt.php?attempt=780942&cmid=168167&page=2");
