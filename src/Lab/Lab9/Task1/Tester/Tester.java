package Lab.Lab9.Task1.Tester;

import Lab.Lab9.Task1.DocumentViewerTest;
...
public class Tester {
    ...
    private DocumentViewerTest tester;
    private static String FILE_PATH;
    private static Scraper SCRAPER;

    @BeforeAll
    static void test() throws IOException, InterruptedException {
        FILE_PATH = "src/Lab/Lab9/Task1/Tester/";
        SCRAPER = new ScrapeCourses("https://courses.finki.ukim.mk/mod/quiz/attempt.php?attempt=780942&cmid=168167&mdlscrollto=2108");
