package Lab.Lab3.Task3.Tester;


import Lab.Lab3.Task3.EnrollmentsTest;
...
public class Tester {
    ...
    private EnrollmentsTest tester;
    private static String FILE_PATH;
    private static Scraper SCRAPER;

    @BeforeAll
    static void test() throws IOException, InterruptedException {
        FILE_PATH = "src/Lab/Lab3/Task3/Tester/";
        SCRAPER = new ScrapeCourses("https://courses.finki.ukim.mk/mod/quiz/attempt.php?attempt=738476&cmid=166557&page=2");
