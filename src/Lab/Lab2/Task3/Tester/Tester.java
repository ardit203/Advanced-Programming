package Lab.Lab2.Task3.Tester;

import Lab.Lab2.Task3.LocalTimeTest;
...
public class Tester {
    ...
    private LocalTimeTest tester;
    private static String FILE_PATH;
    private static Scraper SCRAPER;

    @BeforeAll
    static void test() throws IOException, InterruptedException {
        FILE_PATH = "src/Lab/Lab2/Task3/Tester/";
        SCRAPER = new ScrapeCourses("https://courses.finki.ukim.mk/mod/quiz/attempt.php?attempt=729487&cmid=166114&page=2");
