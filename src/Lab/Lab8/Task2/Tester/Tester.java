package Lab.Lab8.Task2.Tester;
import Lab.Lab8.Task2.TriviaGame;
...
public class Tester {
    ...
    private TriviaGame tester;
    private static String FILE_PATH;
    private static Scraper SCRAPER;

    @BeforeAll
    static void test() throws IOException, InterruptedException {
        FILE_PATH = "src/Lab/Lab8/Task2/Tester/";
        SCRAPER = new ScrapeCourses("https://courses.finki.ukim.mk/mod/quiz/attempt.php?attempt=773913&cmid=168028&page=1");
