package Lab.Lab8.Task3.Tester;
import Lab.Lab8.Task3.Main;
...
public class Tester {
    ...
    static void test() throws IOException, InterruptedException {
        FILE_PATH = "src/Lab/Lab8/Task3/Tester/";
        SCRAPER = new ScrapeCourses("https://courses.finki.ukim.mk/mod/quiz/attempt.php?attempt=773913&cmid=168028&page=2");
