package Lab.Lab8.Additional.Tester;

import Lab.Lab8.Additional.ExpensesManagementSystemTest;
...
public class Tester {
    ...
    private ExpensesManagementSystemTest tester;
    private static String FILE_PATH;
    private static Scraper SCRAPER;

    @BeforeAll
    static void test() throws IOException, InterruptedException {
        FILE_PATH = "src/Lab/Lab8/Additional/Tester/";
        SCRAPER = new ScrapeCourses("https://courses.finki.ukim.mk/mod/quiz/attempt.php?attempt=776240&cmid=168162&mdlscrollto=3200");
