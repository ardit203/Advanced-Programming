package Lab.Lab7.Task2.Tester;

import Lab.Lab7.Task2.FakeApiPing;
...
public class Tester {
    ...
    private FakeApiPing tester;
    private static String FILE_PATH;
    private static Scraper SCRAPER;

    @BeforeAll
    static void test() throws IOException, InterruptedException {
        FILE_PATH = "src/Lab/Lab7/Task2/Tester/";
        SCRAPER = new ScrapeCourses("https://courses.finki.ukim.mk/mod/quiz/attempt.php?attempt=767109&cmid=167783&page=1");
