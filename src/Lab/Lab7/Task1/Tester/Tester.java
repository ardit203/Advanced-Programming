package Lab.Lab7.Task1.Tester;

import Lab.Lab7.Task1.TextCounter;
...
public class Tester {
    ...
    private TextCounter tester;
    private static String FILE_PATH;
    private static Scraper SCRAPER;

    @BeforeAll
    static void test() throws IOException, InterruptedException {
        FILE_PATH = "src/Lab/Lab7/Task1/Tester/";
        SCRAPER = new ScrapeCourses("https://courses.finki.ukim.mk/mod/quiz/attempt.php?attempt=767109&cmid=167783");
