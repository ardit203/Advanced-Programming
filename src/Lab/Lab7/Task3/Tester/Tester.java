package Lab.Lab7.Task3.Tester;

import Lab.Lab7.Task3.BankBalance;
...
public class Tester {
    ...
    private BankBalance tester;
    private static String FILE_PATH;
    private static Scraper SCRAPER;

    @BeforeAll
    static void test() throws IOException, InterruptedException {
        FILE_PATH = "src/Lab/Lab7/Task3/Tester/";
        SCRAPER = new ScrapeCourses("https://courses.finki.ukim.mk/mod/quiz/attempt.php?attempt=767109&cmid=167783&page=2");
